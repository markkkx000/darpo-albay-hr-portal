                    ...
                    <CardHeader className="border-b border-muted/20 pb-6">
                        <div className="space-y-4">
                            <div className="flex items-center gap-3">
                                <div
                                    className={cn(
                                        'sqicon rounded-xl p-2',
                                        announcement.priority === 'high'
                                            ? 'sqicon-red shadow-[0_0_15px_rgba(239,68,68,0.4)]'
                                            : 'sqicon-green',
                                    )}
                                >
                            ...
                            <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-muted-foreground">
                                ...
                                <span
                                    className={cn(
                                        'rounded-full px-3 py-1 text-[10px] font-bold tracking-wider uppercase shadow-sm transition',
                                        announcement.priority === 'high'

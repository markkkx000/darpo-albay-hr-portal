...
export const DateSection: React.FC<DateSectionProps> = ({
    ...
    const addSpecificDate = () => {
        if (
            specificDateInput &&
            !data.specific_dates.includes(specificDateInput)
        ) {
            setData(
                'specific_dates',
                [...data.specific_dates, specificDateInput].sort(),
            );
    ...
    const removeSpecificDate = (dateToRemove: string) => {
        setData(
            'specific_dates',
            data.specific_dates.filter((d: string) => d !== dateToRemove),
        );
    };
                ...
                <SlidingTabs
                    ...
                    tabs={[
                        ...
                        },
                        {
                            ...
                            active: dateMode === 'specific',
                        },
                    ]}
                    onChange={(val) =>
                        toggleDateMode(val as 'range' | 'specific')
                    }
                />
            </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                setData('days_requested', e.target.value)
                            }
                    ...
                    <div className="flex flex-wrap gap-2">
                        {data.specific_dates.map((d: string) => (
                            <div key={d} className="badge-premium group">
                                <span>
                                    {parseLocalDate(d)?.toLocaleDateString(
                                        'en-GB',

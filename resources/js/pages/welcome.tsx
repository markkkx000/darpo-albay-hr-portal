        ...
        <div className="relative min-h-screen">
            ...
            <div className="relative z-10 flex min-h-screen flex-col font-sans">
                ...
                <header className={cn(
                    ...
                    scrolled 
                        ? "border-border-1 bg-background/90 backdrop-blur-xl saturate-[1.8]" 
                    ...
                    <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
                        ...
                        <nav aria-label="Primary navigation">
                            {auth.user ? (
                                ...
                                <Link href={login()} className="px-4 py-2 rounded-xl text-xs font-bold uppercase tracking-wider border border-border/50 hover:item-hover-gradient hover:!text-black text-foreground transition-all">
                                    Sign In
                                </Link>
                            )}
                        </nav>
                ...
                <main className="flex flex-1 flex-col items-center px-6 py-20 sm:py-24 lg:py-32" id="hero">
                    ...
                    {/* ── Features Header ── */}
                    <div ref={featuresRef} className={cn("text-center mt-32 md:mt-40 transition-all duration-1000 ease-out", featuresVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10")}>
                    ...
                    <div className={cn("mt-16 grid w-full max-w-6xl grid-cols-1 md:grid-cols-12 gap-6 transition-all duration-1000 ease-out delay-200", featuresVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10")} role="list" aria-label="Portal features">
                        
                        {/* Primary Feature (Spans 2 columns on desktop) */}
                        <article className="matte-card elev-2 hover:bg-surface-3 hover:border-primary/20 md:col-span-12 lg:col-span-8 flex flex-col md:flex-row items-center gap-8 p-8 md:p-10 text-left spring-hover transition-colors" role="listitem">
                        ...
                        {/* Standard Feature */}
                        <article className="matte-card elev-2 hover:bg-surface-3 hover:border-primary/20 md:col-span-6 lg:col-span-4 flex flex-col items-start gap-5 p-8 md:p-10 text-left spring-hover transition-colors" role="listitem">
                ...
                {/* ── Footer ── */}
                <footer className="mt-20 md:mt-32 border-t border-border-1 bg-background/50 backdrop-blur-md">
